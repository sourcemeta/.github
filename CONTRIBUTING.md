...
Every Sourcemeta project enforces the [Developer Certificate of Origin
(DCO)](https://developercertificate.org), a statement introduced by the Linux
Foundation to ensure the contributor is allowed to make the contribution and
that the project may distribute it under its license. It requires you to
sign off your [Git](https://git-scm.com) commits, which you can do with the
[`--signoff`](https://git-scm.com/docs/git-commit#Documentation/git-commit.txt---signoff)
command-line flag.

Signing off a commit has two cumulative effects: you certify the Developer
Certificate of Origin and you accept the Contribution License below for the
corresponding contribution. The Contribution License is in addition to, and
independent of, the Developer Certificate of Origin and the project license,
and prevails over both as to the rights you grant to Sourcemeta.

Contribution License
--------------------

These terms are an agreement between you and Sourcemeta OÜ, a private limited
company registered in Estonia under registry code 17180733 ("Sourcemeta").
Except for the licenses granted below, you retain all right, title, and
interest in your contributions.

"You" means the individual or legal entity accepting these terms, and for a
legal entity includes any entity that controls it, is controlled by it, or is
under common control with it, meaning owning more than half of the voting
interests or directing management. If you accept on behalf of a legal entity,
you represent that you have authority to bind it. If your contributions are
owned by your employer or another entity, that entity must accept these terms
through someone authorized to bind it, and you will ensure that any entity
owning rights in your contributions accepts these terms or grants Sourcemeta
the same licenses. You represent that you have full legal capacity to accept
these terms.
...
authoritative record and each contribution identified by its version control
record. By accepting these terms through a sign-off or statement, you also
accept them for, and they then govern, every contribution you previously
submitted while Sourcemeta administered the corresponding project, in
addition to, and without limiting or revoking, any license previously granted
to any person, unless you exclude past contributions by notifying Sourcemeta,
in a format that can be reproduced in writing, when you accept these terms.

### Grant of Copyright License

You grant Sourcemeta a worldwide, non-exclusive, no-charge, royalty-free, and
irrevocable copyright license, for the entire duration of the copyright,
...
Sourcemeta will consider contributions in good faith and preserve authorship
...
[hello@sourcemeta.com](mailto:hello@sourcemeta.com). These terms are governed
by the laws of the Republic of Estonia, and disputes are subject to the
non-exclusive jurisdiction of the Estonian courts, without prejudice to
mandatory rules entitling you to sue or be sued elsewhere.
